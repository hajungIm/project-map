...
import com.springstudy.projectmap.pharmacy.repository.PharmacyRepository
...
class PharmacyRepositoryServiceTest extends AbstractIntegrationContainerBaseTest {
    ...
    def "PharmacyRepository update - dirty checking success"() {
        given:
        String inputAddress = "서울 특별시 성북구 중암동"
    ...
    def "transactional readOnly test"() {
        ...
        String modifiedAddess = "서울 특별시 광진구"
        String name = "은혜 약국"
        double latitude = 36.11
        double longitude = 128.11
        ...
        pharmacyRepositoryService.startReadOnlyMethod(pharmacy.getId())
